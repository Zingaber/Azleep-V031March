...
export function SleepQuote({ className }: SleepQuoteProps) {
  ...
  return (
    <Card className={cn("sleep-card border-primary/10 p-4 relative overflow-hidden", className)}>
